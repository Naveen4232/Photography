...
const Services = () => {
  return (
    <div className='experience bg-white w-screen text-white' id='services' style={{ marginTop: '7rem' }}>
      <div className='px-2 text-center'>
        <h4 className='font-light'>We are happy to serve</h4>
